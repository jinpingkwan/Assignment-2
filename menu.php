    ...
    <!-- Menu category -->
        <div class = "menu_list">
            <div class = "menu_category">
                ...
                <a href="#pure_tea">
                    <div class = "category2">
                        <img src="images/Chatea/11.png" alt="">
                        <h3>pure_tea</h3>
                    </div>
                </a>

               <h1 class =  "brief">Click to know more about our tea  </h1>
               
               
               <a href="#fruit_tea">
                    <div class = "category3">
                        <img src="images/Chatea/27.png" alt="">
                        <h3>Fruit Tea</h3>
                    </div>
                </a>
                ...
                <a href ="#new_launch">
                    <div class = "category4">
                        <img src="images/Chatea/24.png" alt="">
                        <h3>New Launch</h3>
                    </div>
                 </a>
                </div>
            ...
            <div id = "milk_tea">
                <div class ="menu_item1">
                    <img src="images/Chatea/1.png" alt="milketea1"  >
